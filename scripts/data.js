data = {
    coderLocations: [
        {
            title: 'Anonymous',
            interest: 'adventure',
            content: 'I chose the jungles of Peru because I plan on going there to reward myself after a year of working in development',
        ...
        },
        {
            title: 'Leia',
            interest: 'education',
            content: 'I chose Monterey, California because I would love to take my family there when I graduate',
        ...
        },
        {
            title: 'Hero-san',
            interest: 'lifeHacks',
            content: 'Japan because they are really good at robots and Life Hacking',
            location: {lat: 36.204824, lng: 138.252924}
        },
        {
            title: 'Mother Teresa',
            interest: 'volunteering',
            content: 'Ethiopia because I feel very lucky to have the opportunity to code. I want to make this opportunity available to people in third-world countries',
    ...
    coderObstaclesLocations: [
        ...
        },
        {
            title: 'Mad Hiker',
            obstacle: 'tooHard',
            content: 'I chose the Appalachian trail because I think it will be hard. I thought coding was hard (it is), but I know that that I CAN DO EEEETTTT!!!',
            location: {lat: 40.478504, lng: -76.540081}
        },
        {
            title: 'Kim Kardashian',
            obstacle: 'drama',
            content: 'I chose Canada because when we elect Hilary or Trump, I plan on taking my family far away from here (I can code from anywhere)!',
            location: {lat: 49.539469, lng: -89.912109}
        },
        {
            title: 'Trump',
